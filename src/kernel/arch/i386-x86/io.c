...
void enableinterrupts(void) { __asm__ volatile("sti"); }             // Enable CPU interrupts by setting the IF flag in EFLAGS
void disableinterrupts(void) { __asm__ volatile("cli"); }            // Disable CPU interrupts by clearing the IF flag in EFLAGS
